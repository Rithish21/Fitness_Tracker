...
mp_drawing = mp.solutions.drawing_utils   #Using utility functions to draw and visualize detected features.
mp_pose = mp.solutions.pose               #Processes an image to estimate human pose.
